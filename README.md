...
The script imports **run_pdb_search**, **run_plot** and **process_csv** functions from **PDB_searchAPI.py**, **plot_crys_details.py** and **chem_class_reagents.py**.
   ...
   - **PDB_searchAPI.py** is the same as in the multiple sequence extraction. the results are saved to a csv file called *pdb_mmcif_extracted.csv*.

   - **plot_crys_details.py**
