...
# for the Laboratory page -- not invented copy.
LAB_ORGANIZATION = {
...
LAB_TEAM = [
    {
        ...
        "role": "Lead Developer & Principal Investigator",
        "contributions": ["Pipeline design", "Core algorithm implementation", "FAIR principles implementation"],
        "email": "njantang@ritarea.org",
        "orcid": "0000-0002-6003-7521",
    },
    {
        "name": "Valerio Piomponi",
        "role": "Co-Developer",
        "contributions": ["Compound annotation", "NLP parsing"],
        "orcid": "0000-0003-0433-8319",
    },
    {
        "name": "Andrea Dalle Vedove",
        "role": "Co-Developer",
        "contributions": ["Web application interface", "Visualization"],
...
def laboratory(request):
    ...
    return render(request, "viewer/laboratory.html", {
        "active_nav": "laboratory",
...
def index(request):
    ...
    Every submitted search gets a SearchRun row (see models.py) and its
    own timestamped output folder, so it shows up in /history/ and stays
    revisitable even if the same protein name is searched again later."""
