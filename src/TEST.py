...
def run_plot(output_csv_file):
    ...
    def all_conditions_with_merged_pdb(df):
        ...
        """
        cond_cols = ["pubmed_id", "method", "plot_pH_numeric"]
    ...
    sub_headers = ["PDB_ID", "score", "pubmed_id", "Assembly","method", "ligands","pH", "temp"]

    # 3️⃣ Column widths
    col_widths = [0.16, 0.05, 0.08, 0.09, 0.11, 0.10, 0.04, 0.04]
    ...
    exp_end = sub_headers.index("ligands")
